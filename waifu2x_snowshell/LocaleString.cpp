...
wstring STRING_TEXT_GPU_CUGAN = L"CUGAN";
wstring STRING_TEXT_GPU_CUGAN_TTA = L"CUGAN (TTA)";
wstring STRING_TEXT_GPU_ESRGAN = L"ESRGAN";
wstring STRING_TEXT_GPU_ESRGAN_TTA = L"ESRGAN (TTA)";
