...
wstring SnowSetting::LangName[LangNum] = { L"한국어", L"English", L"日本語", L"中文", L"Deutsch", L"Svenska" , L"Portuguese", L"Ukrainian", L"Svenska", L"Русский"};
wstring SnowSetting::LangFile[LangNum] = { L"Korean.ini", L"English.ini", L"Japanese.ini", L"Chinese.ini", L"German.ini", L"Swedish.ini", L"Portuguese.ini", L"Ukrainian.ini", L"Swedish.ini", L"Russian.ini"};
